    ...
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (args.Length < 1)
            {
                ...
                Console.WriteLine("creditcoin RegisterDealOrder askAddressId bidAddressId amount interest maturity fee expiration fundraiserSignature fundraiserPublicKey dealOrderId blockchainTxId");
